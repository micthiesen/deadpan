...
- `deadpan-plan`: immutable indexed picture mappings and [exact structural audio spans](docs/AUDIO_PLAN.md), with separate [sample clocks and retained envelopes](docs/AUDIO_SAMPLING.md), exact retiming, stable repeated-play identities, and sparse play overrides.
