...
- `deadpan-audio`: [exact source resampling and explicit stereo mixing](docs/AUDIO_PREPARATION.md), [plan-driven source PCM](docs/SOURCE_STAGE_AUDIO.md) and [continuous Preserve retimes](docs/AUDIO_STAGE_PREPARATION.md) from verified originals; the full voice graph remains open.
