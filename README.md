...
- `deadpan-cli`: headless project/command/history operations, migration, picture/audio-plan and source-PCM inspection, [physical audio context inspection](docs/AUDIO_PHYSICAL_DOMAINS.md), and exact boundary selection, also available through `deadpan-app --headless`.
