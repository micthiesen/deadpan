...
- `deadpan-cli`: headless project/command/history operations, migration, picture/audio-plan and source-PCM inspection, [physical audio contexts](docs/AUDIO_PHYSICAL_DOMAINS.md), [authored audio definitions](docs/AUDIO_DEFINITIONS.md), and exact boundary selection, also available through `deadpan-app --headless`.
