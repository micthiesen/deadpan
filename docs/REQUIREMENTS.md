...
The native import workflow remains open.
...
existing command path. Native queue/UI integration and measured large-media
latency remain open. The [qualification report](qualification/import-preparation-2026-09-21.md)
