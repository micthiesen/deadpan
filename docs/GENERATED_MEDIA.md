...
Database schema 6 and authored document schema 4 are unchanged. Publishing bytes
...
provenance bundles, history reference tracking, explicit undoable acceptance,
