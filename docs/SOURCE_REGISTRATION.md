...
Database schema 18 stores immutable receipts in `source_qualifications`, separate
from authored undo history. Core schema 12 assets bind `source_qualification` to
