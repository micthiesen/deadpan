...
unchanged attempts, receipts and selection across migration to database schema 8.
...
Every migration retains a `Snapshots/before-schema-8-*.sqlite` backup and promotes
