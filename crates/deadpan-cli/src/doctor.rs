...
pub fn report() -> Result<serde_json::Value, CliError> {
    ...
    Ok(serde_json::json!({
        ...
        "partial": ["structural-editing-commands", "sqlite-project-history", "schema-1-through-4-migration", "indexed-picture-plan", "exact-boundary-selectors", "persistent-marks", "sparse-play-overrides", "nested-occurrence-edits", "persistent-generation-requests"],
