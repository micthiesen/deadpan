//! Exact source-picture extent, independent of the integer timeline duration.
...
/// timeline occupancy, never an implicit rate conversion for `Duration`.
...
impl SourceVideoMapping {
    ...
    pub fn endpoints(self) -> EndpointPolicy {
        match self {
            ...
            Self::Duration { endpoints, .. } => endpoints,
        }
    }
}
