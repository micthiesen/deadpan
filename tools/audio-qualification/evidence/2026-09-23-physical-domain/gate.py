...
out = Path('/tmp/deadpan-physical-domain-20260923/gate')
...
commands = [['cargo', 'fmt', '--all', '--', '--check'], ['cargo', 'clippy', '--workspace', '--all-targets', '--locked', '--', '-D', 'warnings'], ['cargo', 'test', '--workspace', '--locked'], ['cargo', 'build', '--workspace', '--locked'], ['cargo', 'run', '-p', 'deadpan-cli', '--', 'doctor'], ['cargo', 'run', '-p', 'deadpan-app', '--locked', '--', '--smoke-test']]
report = []
